    ...
    <div class="auth-card card">
      ...
      <form class="auth-form" @submit.prevent="submit">
        <div class="field">
          ...
          <input v-model="form.name" class="input" type="text" placeholder="John Doe" required />
        </div>
        <div class="field">
        ...
        <div class="field">
          ...
          <input v-model="form.password" class="input" type="password" placeholder="Min. 6 characters" required minlength="6" />
        </div>
...
export default {
  data() {
    return { form: { name: '', email: '', password: '' }, error: '', loading: false }
  },
  methods: {
    async submit() {
      this.error = ''
